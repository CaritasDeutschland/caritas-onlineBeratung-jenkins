# Caritas Online-Beratung Jenkins
This is the repository containing all files to build the Jenkins Docker container.
...
## License
The project is licensed under the AGPLv3 which you'll find [here](https://github.com/CaritasDeutschland/caritas-onlineBeratung-jenkins/blob/master/LICENSE.md).
